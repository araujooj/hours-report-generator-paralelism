defmodule HoursReportGeneratorTest do
  ...
  describe "build_from_many/1" do
    test "when a file list is provided, builds the report" do
      filenames = ["gen_report_test", "gen_report_test"]

      response = HoursReportGenerator.build_from_many(filenames)
    ...
    test "when a invalid option is provided, returns an error" do
      invalid_filename = "invalid option"

      response = HoursReportGenerator.build_from_many(invalid_filename)

      expected_response = {:error, "Provide a list of files"}
